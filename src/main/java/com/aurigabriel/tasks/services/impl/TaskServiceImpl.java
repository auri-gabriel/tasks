...
import com.aurigabriel.tasks.repositories.TaskRepository;
...
public class TaskServiceImpl implements TaskService {
    ...
    public Task createTask(UUID taskListId, Task task) {
        if (null != task.getId()) {
            throw new IllegalArgumentException("Passed Task object shouldn't have an ID!");
        }

        if (null == task.getTitle() || task.getTitle().isBlank()) {
            throw new IllegalArgumentException("Passed Task must have a title!");
        }
    ...
    public Task updateTask(UUID taskListId, UUID taskId, Task task) {
        if (null == task.getId()) {
            throw new IllegalArgumentException("Passed Task must have an ID!");
        }
        ...
        if (null == task.getPriority()){
            throw new IllegalArgumentException("Passed Task must have a priority!");
        }

        if (null == task.getStatus()){
            throw new IllegalArgumentException("Passed Task must have a status!");
        }
